...
class Model(nn.Module):
    ...
    def __call__(
        ...
        **kwargs,
        ...
        Returns:
            (List[WCUA-YOLO.engine.results.Results]): A list of prediction results, each encapsulated in a
                Results object.
    ...
    def predict(
        ...
        **kwargs,
        ...
        is_cli = (ARGV[0].endswith("yolo") or ARGV[0].endswith("WCUA-YOLO")) and any(
    ...
    def track(
        ...
        **kwargs,
        ...
        Returns:
            (List[WCUA-YOLO.engine.results.Results]): A list of tracking results, each a Results object.
    ...
    def val(
        ...
        **kwargs,
        ...
        Args:
            validator (WCUA-YOLO.engine.validator.BaseValidator | None): An instance of a custom validator class for
                validating the model.
            **kwargs (Any): Arbitrary keyword arguments for customizing the validation process.

        Returns:
            (WCUA-YOLO.utils.metrics.DetMetrics): Validation metrics obtained from the validation process.
    ...
    def benchmark(
        ...
        **kwargs,
        ...
        It uses the 'benchmark' function from the WCUA-YOLO.utils.benchmarks module. The benchmarking is
    ...
    def tune(
        ...
        **kwargs,
        ...
        When Ray Tune is enabled, it leverages the 'run_ray_tune' function from the WCUA-YOLO.utils.tuner module.
    ...
    def names(self) -> Dict[int, str]:
        ...
        using the 'check_class_names' function from the WCUA-YOLO.nn.autobackend module. If the predictor is not
