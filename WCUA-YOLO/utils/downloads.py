...
GITHUB_ASSETS_REPO = "WCUA-YOLO/assets"
GITHUB_ASSETS_NAMES = (
...
def delete_dsstore(path, files_to_delete=(".DS_Store", "__MACOSX")):
    ...
    Example:
        ```python
        from WCUA-YOLO.utils.downloads import delete_dsstore
...
def zip_directory(directory, compress=True, exclude=(".DS_Store", "__MACOSX"), progress=True):
    ...
    Example:
        ```python
        from WCUA-YOLO.utils.downloads import zip_directory
...
def unzip_file(file, path=None, exclude=(".DS_Store", "__MACOSX"), exist_ok=False, progress=True):
    ...
    Example:
        ```python
        from WCUA-YOLO.utils.downloads import unzip_file
...
def get_google_drive_file_info(link):
    ...
    Example:
        ```python
        from WCUA-YOLO.utils.downloads import get_google_drive_file_info
...
def safe_download(
    ...
    Example:
        ```python
        from WCUA-YOLO.utils.downloads import safe_download
...
def get_github_assets(repo="WCUA-YOLO/assets", version="latest", retry=False):
    """
    Retrieve the specified version's tag and assets from a GitHub repository. If the version is not specified, the
    function fetches the latest release assets.

    Args:
        repo (str, optional): The GitHub repository in the format 'owner/repo'. Defaults to 'WCUA-YOLO/assets'.
    ...
    Example:
        ```python
        tag, assets = get_github_assets(repo="WCUA-YOLO/assets", version="latest")
        ```
    """
    if version != "latest":
...
def attempt_download_asset(file, repo="WCUA-YOLO/assets", release="v8.3.0", **kwargs):
    """
    ...
    Example:
        ```python
        file_path = attempt_download_asset("yolo11n.pt", repo="WCUA-YOLO/assets", release="latest")
        ```
    """
