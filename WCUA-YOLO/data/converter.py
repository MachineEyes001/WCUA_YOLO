...
def convert_coco(
    ...
    Example:
        ```python
        from WCUA-YOLO.data.converter import convert_coco
...
def convert_segment_masks_to_yolo_seg(masks_dir, output_dir, classes):
    ...
    Example:
        ```python
        from WCUA-YOLO.data.converter import convert_segment_masks_to_yolo_seg
...
def convert_dota_to_yolo_obb(dota_root_path: str):
    ...
    Example:
        ```python
        from WCUA-YOLO.data.converter import convert_dota_to_yolo_obb
...
def create_synthetic_coco_dataset():
    ...
    Examples:
        >>> from WCUA-YOLO.data.converter import create_synthetic_coco_dataset
