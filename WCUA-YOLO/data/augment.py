...
class Compose:
    ...
    def __init__(self, transforms):
        ...
        Examples:
            >>> from WCUA-YOLO.data.augment import Compose, RandomHSV, RandomFlip
...
class Mosaic(BaseMixTransform):
    ...
    Examples:
        >>> from WCUA-YOLO.data.augment import Mosaic
...
class MixUp(BaseMixTransform):
    ...
    Examples:
        >>> from WCUA-YOLO.data.augment import MixUp
        >>> dataset = YourDataset(...)  # Your image dataset
    ...
    def __init__(self, dataset, pre_transform=None, p=0.0) -> None:
        ...
        Examples:
            >>> from WCUA-YOLO.data.dataset import YOLODataset
...
class RandomHSV:
    ...
    Examples:
        >>> import numpy as np
        >>> from WCUA-YOLO.data.augment import RandomHSV
    ...
    def __call__(self, labels):
        ...
        Args:
            labels (Dict): A dictionary containing the following keys:
                ...
                'instances' (WCUA-YOLO.utils.instance.Instances): An object containing bounding boxes and
                    optionally keypoints.

        Returns:
            (Dict): The same dictionary with the flipped image and updated instances:
                'img' (numpy.ndarray): The flipped image.
                'instances' (WCUA-YOLO.utils.instance.Instances): Updated instances matching the flipped image.
...
class CopyPaste(BaseMixTransform):
    ...
    Examples:
        >>> from WCUA-YOLO.data.augment import CopyPaste
        >>> dataset = YourDataset(...)  # Your image dataset
...
def v8_transforms(dataset, imgsz, hyp, stretch=False):
    ...
    Examples:
        >>> from WCUA-YOLO.data.dataset import YOLODataset
        >>> from WCUA-YOLO.utils import IterableSimpleNamespace
...
def classify_transforms(
    ...
    """
    import torchvision.transforms as T  # scope for faster 'import WCUA-YOLO'
